---
layout: post
title: Docker-安装完整Ubuntu
---

在 Docker 里的 Ubuntu 使用 man 命令时，总是提示：
...
而输入 Unminimize 命令又总是显示找不到该命令，翻来覆去找不到答案。最后看到了一篇博客(贴在文末了)。其实并不是每个 ubuntu 版本都有这个 unminimize，所以把这个脚本贴出来了。
...
[https://m2kar.cn/posts/20200316-full-ubuntu-docker/](https://m2kar.cn/posts/20200316-full-ubuntu-docker/)
